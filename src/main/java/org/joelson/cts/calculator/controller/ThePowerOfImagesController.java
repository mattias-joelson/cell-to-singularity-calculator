...
public class ThePowerOfImagesController {
    ...
    private final Garden garden = ThePowerOfImages.createGarden(1, 1, 0);
...
//                "Legacy", // check
    ...
    @GetMapping("/powerofimages")
    public String powerOfImages(Model model) {
        initState();
        return updateModel(model);
    }

    @PostMapping("/powerofimages-generator-update")
    ...
    @PostMapping("/powerofimages-generator-increment")
    ...
    @PostMapping("/powerofimages-generator-decrement")
    ...
    @PostMapping("/powerofimages-upgrade")
