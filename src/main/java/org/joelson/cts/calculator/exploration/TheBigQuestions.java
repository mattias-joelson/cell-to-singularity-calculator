...
public class TheBigQuestions {
    ...
    public static Garden createGarden(int costMultiplier, int productionMultiplier, float badgeBonus) {
        ...
        builder.createGenerator("Ethics", questions(2_000), questions(12))
        ...
        builder.createGenerator("Political Philosophy", questions(150_000), questions(300))
        ...
        builder.createGenerator("Epistemology", questions(3e8), questions(100_000))
        ...
        builder.createGenerator("Metaphysics", questions(1e13), questions(8e8))
        ...
        builder.createGenerator("Spirit", questions(1.2e18), questions(1e14))
        ...
        builder.createGenerator("Meaning of Life", questions(2e24), questions(1e20))
...
//        Garden.generateGeneratorUpgradesNames(garden);
        ...
        setGeneratorCount(garden, state, "Meaning of Life", 0);
        setGeneratorCount(garden, state, "Spirit", 0);
        setGeneratorCount(garden, state, "Metaphysics", 0);
        setGeneratorCount(garden, state, "Epistemology", 0);
        setGeneratorCount(garden, state, "Political Philosophy", 0);
        setGeneratorCount(garden, state, "Ethics", 0);
