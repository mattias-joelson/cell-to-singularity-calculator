...
void main() {
    ...
    Generator fungi = builder.createGenerator("Fungi", fungus(20), 1.15f, fungus(1))
            ...
            .addUpgrade("Mycology", fungus(600), 1.5f, false) // Fungi
            .addGeneratorRequirement("Fungi", 1)

            .addUpgrade("Mushrooms", fungus(5_000), 11, false) // Fungi
            .addGeneratorRequirement("Fungi", 1)

            .addUpgrade("Yeast", fungus(2e15f), 2e9f, false) // Tasty Fungi / Fungi
            .addGeneratorRequirement("Fungi", 1)
            .addGeneratorRequirement("Tasty Fungi", 1)

            .addUpgrade("Mold", fungus(2e18f), 251, false) // Blue Cheese / Fungi
            .addGeneratorRequirement("Fungi", 1)
            .addUpgradeRequirement("Blue Cheese")
            .generator();

    Generator fungalLiving = builder.createGenerator("Fungal Living", fungus(700), 1.15f, fungus(5)) // Mycology
            .addUpgradeRequirement("Mycology")

            .addUpgrade("Diet", fungus(1_250), 2, false)  // Fungal Living
            .addGeneratorRequirement("Fungal Living", 1)

            .addUpgrade("Reproduction", fungus(2_000), 2, false) // Fungal Living
            .addGeneratorRequirement("Fungal Living", 1)

            .addUpgrade("Hydrolytic Enzymes", fungus(50_000), 2, false) // Diet
            .addUpgradeRequirement("Diet")

            .addUpgrade("Spores", fungus(150_000), 3, false) // Reproduction
            .addUpgradeRequirement("Reproduction")

            .addUpgrade("Symbiosis", fungus(5e7f), 51, false) // Fungal Living
            .addGeneratorRequirement("Fungal Living", 1)

            .addUpgrade("Growth", fungus(1e9f), 11, false) // Reproduction
            .addUpgradeRequirement("Reproduction")
            .generator();

    Generator fungalCleaners = builder.createGenerator("Fungal Cleaners", fungus(600_000), 1.15f, fungus(400)) // Hydrolytic Enzymes
            .addUpgradeRequirement("Hydrolytic Enzymes")

            .addUpgrade("Bioremediation", fungus(2e6f), 3, false) // cleaners
            .addGeneratorRequirement("Fungal Cleaners", 1)

            .addUpgrade("Radiotrophic Fungi", fungus(1.5e7f), 4, false) // bioremediation
            .addUpgradeRequirement("Bioremediation")

            .addUpgrade("Decomposition", fungus(1.5e10f), 16, false) // cleaners
            .addGeneratorRequirement("Fungal Cleaners", 1)

            .addUpgrade("Fungal Burial", fungus(1.5e11f), 26, false) // decomposition
            .addUpgradeRequirement("Decomposition")
            .generator();

    Generator fungiOfTheForest = builder.createGenerator("Fungi of the Forest", fungus(3e8f), 1.15f, fungus(50_000)) // Symbiosis
            .addUpgradeRequirement("Symbiosis")

            .addUpgrade("Mycorrhiza", fungus(7e8f), 2, false) // fungi of the forest
            .addGeneratorRequirement("Fungi of the Forest", 1)

            .addUpgrade("Mycelial Network", fungus(9e9f), 2, false) // growth / fungi of the forest
            .addGeneratorRequirement("Fungi of the Forest", 1)
            .addUpgradeRequirement("Growth")

            .addUpgrade("Ghost Orchid", fungus(4e10f), 2, false) // decomposition / fungi of the forest
            .addGeneratorRequirement("Fungi of the Forest", 1)
            .addUpgradeRequirement("Decomposition")

            .addUpgrade("Defense Alert", fungus(8e10f), 2, false) // mycelial network
            .addUpgradeRequirement("Mycelial Network")
            .generator();

    Generator domesticatedFungi = builder.createGenerator("Domesticated Fungi", fungus(1.5e11f), 1.15f, fungus(6e6f)) // fungal burial
            .addUpgradeRequirement("Fungal Burial")

            .addUpgrade("Building Material", fungus(6e11f), 4, false) // dom fun
            .addGeneratorRequirement("Domesticated Fungi", 1)

            .addUpgrade("Pesticides", fungus(1.5e12f), 11, false) // dom fun
            .addGeneratorRequirement("Domesticated Fungi", 1)

            .addUpgrade("Medicine", fungus(2e13f), 3, false) // dom fun
            .addGeneratorRequirement("Domesticated Fungi", 1)

            .addUpgrade("Antibiotics", fungus(4e20f), 3e6f, false) // medicine, mold
            .addUpgradeRequirement("Medicine")
            .addUpgradeRequirement("Mold")
            .generator();

    Generator tastyFungi = builder.createGenerator("Tasty Fungi", fungus(3.5e13f), 1.15f, fungus(5e9f)) // medicine
            .addUpgradeRequirement("Medicine")

            .addUpgrade("Edible Mushrooms", fungus(1.2e14f), 3, false) // tasty fungi
            .addGeneratorRequirement("Tasty Fungi", 1)

            .addUpgrade("Truffles", fungus(8e14f), 2.5f, false) // edible
            .addUpgradeRequirement("Edible Mushrooms")

            .addUpgrade("Bread", fungus(4e16f), 5, false) // Truffles
            .addUpgradeRequirement("Truffles")

            .addUpgrade("Fermentation", fungus(9e16f), 2, false) // Truffles
            .addUpgradeRequirement("Truffles")

            .addUpgrade("Cheese Ripening", fungus(2.5e17f), 5, false) // Fermentation
            .addUpgradeRequirement("Fermentation")

            .addUpgrade("Blue Cheese", fungus(7.5e17f), 2.5f, false) // Cheese Ripening
            .addUpgradeRequirement("Cheese Ripening")

            .addUpgrade("Alcohol", fungus(9e22f), 75_001, false) // Fermentation
            .addUpgradeRequirement("Fermentation")
            .generator();

    Generator unwelcomeFungi = builder.createGenerator("Unwelcome Fungi", fungus(1.2e19f), 1.15f, fungus(2.5e14f)) // Mold
            .addUpgradeRequirement("Mold")

            .addUpgrade("Moldy Food", fungus(1.5e19f), 9, false) // Unwelcome Fungi
            .addGeneratorRequirement("Unwelcome Fungi", 1)

            .addUpgrade("Fungal Infections", fungus(6e19f), 2.5f, false) // Unwelcome Fungi
            .addGeneratorRequirement("Unwelcome Fungi", 1)

            .addUpgrade("Plant Blight", fungus(5e21f), 6, false) // Fungal Infection
            .addUpgradeRequirement("Fungal Infections")

            .addUpgrade("Black Mold", fungus(1.2e22f), 4, false) // Moldy food
            .addUpgradeRequirement("Moldy Food")

            .addUpgrade("Human Illness", fungus(4e22f), 2, false) // Black Mold, Fungal Infections
            .addUpgradeRequirement("Black Mold")
            .addUpgradeRequirement("Fungal Infections")

            .addUpgrade("Poisonous Mushrooms", fungus(3e24f), 41, false) // Unwelcome Fungi
            .addGeneratorRequirement("Unwelcome Fungi", 1)

            .addUpgrade("Amanita", fungus(1e25f), 5, false) // Poisonous Mushrooms
            .addUpgradeRequirement("Poisonous Mushrooms")

            .addUpgrade("Parasitic Fungi", fungus(1e26f), 16, false) // Unwelcome Fungi
            .addGeneratorRequirement("Unwelcome Fungi", 1)
            .generator();

    Generator mindAlteringFungi = builder.createGenerator("Mind-Altering Fungi", fungus(1e23f), 1.15f, fungus(5e18f)) // alcohol
            .addUpgradeRequirement("Alcohol")

            .addUpgrade("Scent & Taste", fungus(4e23f), 7, false) // Mind-Altering
            .addGeneratorRequirement("Mind-Altering Fungi", 1)

            .addUpgrade("Psychedelic Mushrooms", fungus(4e25f), 16, false) // Mind-Altering, poisonous
            .addGeneratorRequirement("Mind-Altering Fungi", 1)
            .addUpgradeRequirement("Poisonous Mushrooms")

            .addUpgrade("Cordyceps", fungus(1e27f), 2, false) // parasitic fungi
